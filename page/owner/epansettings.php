...
class page_owner_epansettings extends page_base_owner {
	...
	function page_index(){
		...
		$this->app->layout->add( 'H3' )->setHTML( '<i class="fa fa-cogs" ></i> '. strtoupper($this->api->current_website['name']) . " General Settings <small>Your basic company details and outgoing email settings </small>" );
